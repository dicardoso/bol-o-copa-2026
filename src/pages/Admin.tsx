                    ...
                    matches.map((m) => (
                      <div key={m.id} className="bg-slate-950 p-6 rounded-3xl border border-slate-800 flex items-center justify-between group">
                         <div className="flex items-center gap-6">
                            <div className="text-center font-bold text-white min-w-[100px]">
                              {m.teamA} <br/> 
                              <span className="text-2xl">{m.flagA?.length < 5 ? m.flagA : '🏳️'}</span>
                            </div>
                            <div className="flex items-center gap-2">
                               <input 
                                 type="number" 
                            ...
                            <div className="text-center font-bold text-white min-w-[100px]">
                              {m.teamB} <br/> 
                              <span className="text-2xl">{m.flagB?.length < 5 ? m.flagB : '🏳️'}</span>
                            </div>
                         </div>
                         <div className="flex items-center gap-4">
